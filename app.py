...
# ✅ 핵심: iframe 안에서 클릭 시 부모 앱 URL을 "origin+pathname+qs"로 이동
CAL_JS = """
<script>
function goTo(qs){
  try{
    ...
    try{
      var base2 = window.top.location.origin + window.top.location.pathname;
      window.top.location.href = base2 + qs;
    }catch(e2){
